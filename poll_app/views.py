...
from poll_app.serializers import ( PollSerializer, QuestionSerializer,
    OptionSerializer,   AnswerSerializer,
    UserPollSerializer, AnswerOneTextSerializer,
    AnswerOneOptionSerializer, AnswerManyOptionSerializer,)
...
class OptionViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return question.question_options.all()
...
class AnswerCreateViewSet(mixins.CreateModelMixin, viewsets.GenericViewSet):
    ...
    def get_serializer_class(self):
        ...
        if question.type_question == 'free_text':
            return AnswerOneTextSerializer
        elif question.type_question == 'option':
